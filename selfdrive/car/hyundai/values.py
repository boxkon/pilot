...
CAN_GEARS = {
  ...
  "use_cluster_gears": {CAR.ELANTRA, CAR.ELANTRA_GT_I30, CAR.KONA, CAR.GRANDEUR_IG, CAR.K7},
...
LEGACY_SAFETY_MODE_CAR = {CAR.HYUNDAI_GENESIS, CAR.IONIQ_EV_LTD, CAR.KIA_OPTIMA_G4,
                          ...
                          CAR.GRANDEUR_IG, CAR.GRANDEUR_IG_HEV, CAR.GRANDEUR_IG_FL, CAR.GRANDEUR_IG_FL_HEV,
                          CAR.GENESIS_EQ900, CAR.GENESIS_EQ900_L,
                          CAR.GENESIS_G90_2019, CAR.MOHAVE, CAR.K7, CAR.K7_HEV, CAR.K9,
                          CAR.K5, CAR.K5_HEV_2022, CAR.K5_HEV_2022
                          }
